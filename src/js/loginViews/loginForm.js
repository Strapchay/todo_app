    ...
    return `
            <form action="" id="login-form" class="form-class">
                <div class="email-box form-box">
                    <input type="email" name="email" placeholder="email" value="testuser123@email.com" required>
                </div>
                <div class="password-box form-box">
                    <input type="password" name="password" placeholder="password" value="Testuser123" required>
                </div>
